...
namespace N2.Templates.Mvc.Areas.Blog.Services
{
    ...
    /// </summary>
    /// <remarks>Code borrowed from Nick Berardi - http://refactormycode.com/codes/333-sanitize-html#refactor_11281</remarks>
    public static class HtmlSanitizerStringExtension
    {
        ...
        /// <summary>
        /// Converts a string to safe HTML.
        /// </summary>
        /// <param name="text">The text to make safe.</param>
        /// <returns>Returns a safe HTML string.</returns>
        ...
        /// </summary>
        /// <param name="text">The text to make safe.</param>
        /// <returns>Returns a clean html string.</returns>
        private static string RemoveInvalidHtmlTags(this string text)
        {
            MatchEvaluator matchEvaluator = new MatchEvaluator((Match m) =>
                {
            ...
            return HtmlTagExpression.Replace(text, matchEvaluator);
        }
    }
}